...
// User C DSP: tulip.install_c_process() and friends. The same bindings as
// shared/modtulip.c's, which this board does not build; the work is all in
// shared/user_c_dsp.c, whose ESP backend compiles with rcc700t on this RISC-V
// part. audio_tab5.c installs the two AMY hooks that run the installed code.
#include "../../../shared/user_c_dsp.h"
...
static MP_DEFINE_CONST_FUN_OBJ_2(tulip_install_c_process_obj, tulip_install_c_process);
...
static MP_DEFINE_CONST_FUN_OBJ_2(tulip_install_c_osc_obj, tulip_install_c_osc);
...
static MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(tulip_c_osc_obj, 2, 3, tulip_c_osc);
...
static MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(tulip_c_process_obj, 2, 3, tulip_c_process);
...
static MP_DEFINE_CONST_FUN_OBJ_1(tulip_c_process_calls_obj, tulip_c_process_calls);
...
static MP_DEFINE_CONST_FUN_OBJ_1(tulip_uninstall_c_process_obj, tulip_uninstall_c_process);
