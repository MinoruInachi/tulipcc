...
/* tulip.amy_message(): see shared/amy_message.inc. Textually included so
 * that TAB5 -- which builds modtulip_tab5.c instead of this file -- can
 * reach the same code without a new translation unit on every target.
 */
#include "amy_message.inc"
